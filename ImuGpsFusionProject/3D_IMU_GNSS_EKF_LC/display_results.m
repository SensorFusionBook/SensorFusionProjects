...
plot([ems_data.time(1), ems_data.time(end)], ems_data.noiseInfo.gyro_bias(1)*ones(1,2), '--r', 'LineWidth', 2);
...
plot([ems_data.time(1), ems_data.time(end)], ems_data.noiseInfo.gyro_bias(2)*ones(1,2), '--r', 'LineWidth', 2);
...
plot([ems_data.time(1), ems_data.time(end)], ems_data.noiseInfo.gyro_bias(3)*ones(1,2), '--r', 'LineWidth', 2);
